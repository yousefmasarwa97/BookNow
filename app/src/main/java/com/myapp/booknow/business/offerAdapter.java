...
//import java.util.List;
//
//public class offerAdapter  extends RecyclerView.Adapter<com.myapp.booknow.business.offerAdapter.ViewHolder> {
//
//
//
//    /**
...
//
//        public offerAdapter(List<User> businessList) {
//            this.offersList = offersList;
//        }
//
//        @Override
//        public com.myapp.booknow.business.offerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//            View view = LayoutInflater.from(parent.getContext())
//                    .inflate(R.layout.featured_card_design, parent, false);
//            return new com.myapp.booknow.business.offerAdapter.ViewHolder(view);
//        }
//
//        @Override
//        public void onBindViewHolder(com.myapp.booknow.business.offerAdapter.ViewHolder holder, int position) {
//            BusinessSpecialOffers business = offersList.get(position);
